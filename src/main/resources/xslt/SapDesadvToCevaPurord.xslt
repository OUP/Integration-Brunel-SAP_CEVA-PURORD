...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:idoc="http://sap.fusesource.org/idoc" exclude-result-prefixes="idoc">
    <xsl:strip-space elements="*" />
    <xsl:output omit-xml-declaration="no" method="xml" indent="yes" />

    <xsl:template match="idoc:DocumentList/document/rootSegment/segmentChildren">
    <Purord>
        <InterchangeSection>
